...
from estimator.car_value.forms import DocumentForm
import codecs
...
def home(request):
	...
	return render(request, 'car_value/home.html', {'documents': documents})
...
def model_form_upload(request):
	if request.method == 'POST':
		...
		if form.is_valid():
			...
			# Decision Tree
			os.system("Rscript testingNewDataSet.R " + str(file_name) +" "+ str(num1))
	...
	return render(request, 'car_value/model_form_upload.html', {
		'form': form,
	})
